...
INSERT INTO dive (diver_id, spot_id, divenumber, divedate, divetime, bottomtime, maxdepth, visibility, airtemp, watertemp, suittype, tanksize, startpressure, endpressure, gastype, oxygen_percentage)
    VALUES ((SELECT diver_id FROM diver WHERE firstname = 'Erkki'), (SELECT spot_id FROM spot WHERE name = 'Coolaroo'), 51, '2011-07-08', 40, 30, 22, 6, 18, 10, 'dry', 14, 210, 90, 'nitrox', 32);
...
INSERT INTO dive (diver_id, spot_id, divenumber, divedate, divetime, bottomtime, maxdepth, visibility, airtemp, watertemp, suittype, tanksize, startpressure, endpressure, gastype, oxygen_percentage)
    VALUES ((SELECT diver_id FROM diver WHERE firstname = 'Sanna'), (SELECT spot_id FROM spot WHERE name = 'Paakkilan avolouhos'), 23, '2012-09-09', 45, 40, 16, 8, 16, 7, 'wet', 12, 280, 130, 'air', 21);
